defmodule Septima.UserFromAuth do
  alias Septima.User
  alias Septima.Authorization
  alias Ueberauth.Auth
  import Ecto

  def get_or_insert(%Auth{provider: :github} = auth, repo) do
    repo.get_by(Authorization, uid: auth.uid, provider: "github")
